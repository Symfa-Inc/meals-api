...
func (i *ImageService) Add(c *gin.Context, path api.PathDish) (domain.Image, int, error) {
	id := c.PostForm("id")
...
func (i *ImageService) Update(c *gin.Context, path api.PathImageDish) (domain.Image, int, error) {
	file, err := c.FormFile("image")
