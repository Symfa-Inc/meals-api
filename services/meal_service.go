...
func (m *MealService) Add(path api.PathClient, body swagger.AddMeal, user interface{}) ([]swagger.GetMeal, int, error) {
...
func (m *MealService) Get(query api.DateRangeQuery, path api.PathClient) ([]swagger.GetMeal, int, error) {
