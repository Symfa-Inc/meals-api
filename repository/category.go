...
func (dc CategoryRepo) Delete(path api_types.PathCategory) (int, error) {
	result := config.DB.
		Unscoped().
...
func (dc CategoryRepo) Update(path api_types.PathCategory, category *domain.Category) (int, error) {
